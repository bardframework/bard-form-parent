...
public class TimeFilterFieldTemplate extends InputFieldTemplate<TimeFilterField, TimeFilter> {
    ...
    @Override
    public void fill(FormTemplate formTemplate, TimeFilterField field, Map<String, String> args, Locale locale, HttpServletRequest httpRequest) throws Exception {
    ...
    @Override
    public boolean isValid(TimeFilterField field, TimeFilter filter, Map<String, String> args) {
