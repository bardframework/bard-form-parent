...
public class DateTimeFilterFieldTemplate extends InputFieldTemplate<DateTimeFilterField, LocalDateTimeFilter> {
    ...
    @Override
    public void fill(FormTemplate formTemplate, DateTimeFilterField field, Map<String, String> values, Locale locale, HttpServletRequest httpRequest) throws Exception {
    ...
    @Override
    public boolean isValid(DateTimeFilterField field, LocalDateTimeFilter filter, Map<String, String> flowData) {
