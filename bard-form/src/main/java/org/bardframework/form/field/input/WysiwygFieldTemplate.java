...
public class WysiwygFieldTemplate extends InputFieldTemplateAbstract<WysiwygField, String> {
    ...
    @Override
    public boolean isValid(String flowToken, WysiwygField field, String value, Map<String, Object> flowData) {
    ...
    @Override
    public void fill(FormTemplate formTemplate, WysiwygField field, Map<String, Object> values, Map<String, Object> args, Locale locale) throws Exception {
