...
public class NumberFilterFieldTemplate extends InputFieldTemplateAbstract<LongFilterField, LongFilter> {
    ...
    @Override
    public boolean isValid(String flowToken, LongFilterField field, LongFilter filter, Map<String, String> flowData) {
    ...
    @Override
    public void fill(FormTemplate formTemplate, LongFilterField field, Map<String, String> values, Locale locale) throws Exception {
