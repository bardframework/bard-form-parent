...
public interface OptionDataSource {
    List<SelectOption> getOptions(Map<String, String> args, Locale locale) throws Exception;

    @JsonIgnore
    default List<String> getIds(Map<String, String> args, Locale locale) throws Exception {
