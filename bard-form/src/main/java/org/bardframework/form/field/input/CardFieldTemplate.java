...
public class CardFieldTemplate extends InputFieldTemplateAbstract<CardField, String> {
    ...
    @Override
    public boolean isValid(String flowToken, CardField field, String value, Map<String, String> flowData) {
        return null != value;
    }

    @Override
    public void fill(FormTemplate formTemplate, CardField field, Map<String, String> args, Locale locale) throws Exception {
