...
import org.bardframework.form.field.MultiSelectField;
...
@TestComponent
public class MultiSelectFieldDataProvider implements FieldDataProvider<MultiSelectField, List<String>> {
