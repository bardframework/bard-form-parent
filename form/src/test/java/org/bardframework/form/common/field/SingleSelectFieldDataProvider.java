...
import org.bardframework.form.field.SingleSelectField;
...
@TestComponent
public class SingleSelectFieldDataProvider implements FieldDataProvider<SingleSelectField, String> {
    private final static Logger LOGGER = LoggerFactory.getLogger(SingleSelectFieldDataProvider.class);
