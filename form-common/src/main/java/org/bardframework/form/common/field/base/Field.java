...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(name = "DATE_TIME", value = DateTimeField.class),
        @JsonSubTypes.Type(name = "DATE_TIME_RANGE", value = DateTimeRangeField.class),
        ...
        @JsonSubTypes.Type(name = "READONLY", value = ReadonlyField.class),
        @JsonSubTypes.Type(name = "SINGLE_CHECKBOX", value = SingleCheckBoxField.class),
        ...
        @JsonSubTypes.Type(name = "TIME", value = TimeField.class),
        @JsonSubTypes.Type(name = "TIME_RANGE", value = TimeRangeField.class),
})
