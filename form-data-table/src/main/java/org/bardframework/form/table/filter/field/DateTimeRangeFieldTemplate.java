...
public class DateTimeRangeFieldTemplate extends FormFieldTemplate<DateTimeFilterField, LocalDateTimeFilter> {
    ...
    @Override
    public boolean isValid(DateTimeFilterField field, LocalDateTimeFilter value) {
