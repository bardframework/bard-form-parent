...
public class DateRangeFieldTemplate extends FormFieldTemplate<DateFilterField, LocalDateFilter> {
    ...
    @Override
    public boolean isValid(DateFilterField field, LocalDateFilter value) {
